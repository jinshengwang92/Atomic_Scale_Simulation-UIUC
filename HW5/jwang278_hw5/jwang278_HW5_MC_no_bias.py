...
def update_position(pset,iat,sigma):
    ...
    delta_x      = np.random.normal(0.0,sigma,3)
    new_ptcl_pos = old_ptcl_pos + delta_x
    return new_ptcl_pos
...
if __name__ == '__main__':
    ...
    num_atoms   = 64
    mass        = 48.0
    dt          = 0.01      # time step 0.032
    temperature = 0.4   # initla temperature 0.728
